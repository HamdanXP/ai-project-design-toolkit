...
import { ProjectTags } from "@/components/project-details/ProjectTags";
              ...
              <CardContent className="p-4 md:p-6 pt-0">
                {isEditing ? (
                  ...
                  <p className="text-muted-foreground mb-4">
                    ...
                    <br />
                    <br />
                    This project uses AI to address specific business needs and
                    improve outcomes. The AI implementation follows responsible
                    design principles to ensure ethical usage and provide real
                    value to users.
                  </p>
                )}
              </CardContent>
